...
//   const activeWs = worksheets.find((w: any) => w.id === activeWorksheetId) as any

//   // Fetch my answers for current worksheet questions
//   const myAnswersQueries = useQuery({
...
//       )
//       return results.filter(Boolean).map((a, i) => ({ ...a, question: activeWs.questions[i] }))
//     },
//     enabled: !!activeWs,
//   })

//   const myAnswers = myAnswersQueries.data || []

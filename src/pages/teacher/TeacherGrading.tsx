...
//   const { data: fullAnswer } = useQuery({
...
//     onSuccess: () => { qc.invalidateQueries({ queryKey: ['answer', selectedAnswer?.id] }); setShowAnnotModal(false); setAnnotForm({ originalText: '', suggestedText: '', comment: '', startOffset: 0, endOffset: 0 }) }
//   })
...
//           <WorksheetTabs worksheets={worksheets} activeId={activeWorksheetId} onSelect={id => { setActiveWorksheetId(id); setSelectedAnswer(null) }} />
//           <div className="p-4">
//             {allAnswers.length === 0 ? (
...
//                 <div className="bg-paper border border-rule p-4 min-h-[120px] font-mono text-sm relative">
...
//                 <button onClick={() => setShowAnnotModal(true)}
...
//                     <strong>{displayAnswer.grade.score}</strong> / {(displayAnswer as any).question?.maxScore} pts
//                   </p>
//                   {displayAnswer.grade.feedback && (
//                     <p className="text-sm text-ink/60 mt-1 italic">"{displayAnswer.grade.feedback}"</p>
//                   )}
...
//             <div>
//               <label className="label block mb-1.5">Original Text (from student's answer)</label>
//               <input className="input-field" value={annotForm.originalText}
//                 onChange={e => setAnnotForm(f => ({ ...f, originalText: e.target.value }))}
//                 placeholder="Text you want to suggest a correction for..." />
//             </div>
//             <div>
...
//                 placeholder="Your recommended text..." />
//             </div>
//             <div>
